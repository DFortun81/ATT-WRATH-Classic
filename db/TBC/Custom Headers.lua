...
for key,value in pairs({
	...
	[-1000109] = _.asset("achievement_featsofstrength_gladiator_01"),
	[-1000110] = _.asset("achievement_featsofstrength_gladiator_02"),
	[-1000111] = _.asset("achievement_featsofstrength_gladiator_03"),
	[-1000112] = _.asset("achievement_featsofstrength_gladiator_04"),
...
for key,value in pairs({
	...
	[-1000107] = HONOR,
	[-1000108] = PVP,
	[-1000109] = "Gladiator: Season 1",
	[-1000110] = "Merciless Gladiator: Season 2",
	[-1000111] = "Vengeful Gladiator: Season 3",
	[-1000112] = "Brutal Gladiator: Season 4",
...
for key,value in pairs({
	...
	[-1000110] = "Erbarmungsloser Gladiator: Season 2",
	[-1000111] = "Rachsüchtiger Gladiator: Season 3",
	[-1000112] = "Brutaler Gladiator: Season 4",
	[-1000134] = "Friedhof",
	[-1000135] = "Bibliothek",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000109] = "Gladiador: Season 1",
	[-1000110] = "Gladiador despiadado: Season 2",
	[-1000111] = "Gladiador vengativo: Season 3",
	[-1000112] = "Gladiador brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000109] = "Gladiateur: Saison 1",
	[-1000110] = "Gladiateur impitoyable: Saison 2",
	[-1000111] = "Gladiateur vengeur: Saison 3",
	[-1000112] = "Gladiateur brutal: Saison 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000109] = "Gladiatore: Season 1",
	[-1000110] = "Gladiatore Spietato: Season 2",
	[-1000111] = "Gladiatore Vendicativo: Season 3",
	[-1000112] = "Gladiatore Brutale: Season 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000109] = "검투사: Season 1",
	[-1000110] = "무자비한 검투사: Season 2",
	[-1000111] = "복수심에 불타는 검투사: Season 3",
	[-1000112] = "야만적인 검투사: Season 4",
	[-1000148] = "한여름 불꽃축제",
	[-1000149] = "해적의 날",
...
for key,value in pairs({
	[-1000109] = "Gladiador: Season 1",
	[-1000110] = "Gladiador Impiedoso: Season 2",
	[-1000111] = "Gladiador Vingativo: Season 3",
	[-1000112] = "Gladiador Brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000109] = "Гладиатор: Сезон 1",
	[-1000110] = "Безжалостный гладиатор: Сезон 2",
	[-1000111] = "Мстительный гладиатор: Сезон 3",
	[-1000112] = "Жестокий гладиатор: Сезон 4",
