...
for key,value in pairs({
	...
	[-1000089] = _.asset("achievement_featsofstrength_gladiator_01"),
	[-1000090] = _.asset("achievement_featsofstrength_gladiator_02"),
	[-1000091] = _.asset("achievement_featsofstrength_gladiator_03"),
	[-1000092] = _.asset("achievement_featsofstrength_gladiator_04"),
...
for key,value in pairs({
	...
	[-1000087] = HONOR,
	[-1000088] = PVP,
	[-1000089] = "Gladiator: Season 1",
	[-1000090] = "Merciless Gladiator: Season 2",
	[-1000091] = "Vengeful Gladiator: Season 3",
	[-1000092] = "Brutal Gladiator: Season 4",
...
for key,value in pairs({
	...
	[-1000090] = "Erbarmungsloser Gladiator: Season 2",
	[-1000091] = "Rachsüchtiger Gladiator: Season 3",
	[-1000092] = "Brutaler Gladiator: Season 4",
	[-1000113] = "Friedhof",
	[-1000114] = "Bibliothek",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000089] = "Gladiador: Season 1",
	[-1000090] = "Gladiador despiadado: Season 2",
	[-1000091] = "Gladiador vengativo: Season 3",
	[-1000092] = "Gladiador brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000089] = "Gladiateur: Saison 1",
	[-1000090] = "Gladiateur impitoyable: Saison 2",
	[-1000091] = "Gladiateur vengeur: Saison 3",
	[-1000092] = "Gladiateur brutal: Saison 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000089] = "Gladiatore: Season 1",
	[-1000090] = "Gladiatore Spietato: Season 2",
	[-1000091] = "Gladiatore Vendicativo: Season 3",
	[-1000092] = "Gladiatore Brutale: Season 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000089] = "검투사: Season 1",
	[-1000090] = "무자비한 검투사: Season 2",
	[-1000091] = "복수심에 불타는 검투사: Season 3",
	[-1000092] = "야만적인 검투사: Season 4",
...
for key,value in pairs({
	[-1000089] = "Gladiador: Season 1",
	[-1000090] = "Gladiador Impiedoso: Season 2",
	[-1000091] = "Gladiador Vingativo: Season 3",
	[-1000092] = "Gladiador Brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000089] = "Гладиатор: Сезон 1",
	[-1000090] = "Безжалостный гладиатор: Сезон 2",
	[-1000091] = "Мстительный гладиатор: Сезон 3",
	[-1000092] = "Жестокий гладиатор: Сезон 4",
