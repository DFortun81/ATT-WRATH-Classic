...
for key,value in pairs({
	...
	[-1000082] = _.asset("achievement_featsofstrength_gladiator_01"),
	[-1000083] = _.asset("achievement_featsofstrength_gladiator_02"),
	[-1000084] = _.asset("achievement_featsofstrength_gladiator_03"),
	[-1000085] = _.asset("achievement_featsofstrength_gladiator_04"),
	...
	[-1000098] = _.asset("Achievement_Zone_Blackrock_01"),
	[-1000099] = _.asset("Achievement_Zone_Blackrock_01"),
	[-1000100] = "Interface/Icons/Spell_Shadow_SummonImp",
	[-1000101] = "Interface/Icons/inv_axe_10",
...
for key,value in pairs({
	...
	[-1000080] = HONOR,
	[-1000081] = PVP,
	[-1000082] = "Gladiator: Season 1",
	[-1000083] = "Merciless Gladiator: Season 2",
	[-1000084] = "Vengeful Gladiator: Season 3",
	[-1000085] = "Brutal Gladiator: Season 4",
...
for key,value in pairs({
	...
	[-1000083] = "Erbarmungsloser Gladiator: Season 2",
	[-1000084] = "Rachsüchtiger Gladiator: Season 3",
	[-1000085] = "Brutaler Gladiator: Season 4",
	[-1000106] = "Friedhof",
	[-1000107] = "Bibliothek",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000082] = "Gladiador: Season 1",
	[-1000083] = "Gladiador despiadado: Season 2",
	[-1000084] = "Gladiador vengativo: Season 3",
	[-1000085] = "Gladiador brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000082] = "Gladiateur: Saison 1",
	[-1000083] = "Gladiateur impitoyable: Saison 2",
	[-1000084] = "Gladiateur vengeur: Saison 3",
	[-1000085] = "Gladiateur brutal: Saison 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000082] = "Gladiatore: Season 1",
	[-1000083] = "Gladiatore Spietato: Season 2",
	[-1000084] = "Gladiatore Vendicativo: Season 3",
	[-1000085] = "Gladiatore Brutale: Season 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000082] = "검투사: Season 1",
	[-1000083] = "무자비한 검투사: Season 2",
	[-1000084] = "복수심에 불타는 검투사: Season 3",
	[-1000085] = "야만적인 검투사: Season 4",
...
for key,value in pairs({
	[-1000082] = "Gladiador: Season 1",
	[-1000083] = "Gladiador Impiedoso: Season 2",
	[-1000084] = "Gladiador Vingativo: Season 3",
	[-1000085] = "Gladiador Brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000082] = "Гладиатор: Сезон 1",
	[-1000083] = "Безжалостный гладиатор: Сезон 2",
	[-1000084] = "Мстительный гладиатор: Сезон 3",
	[-1000085] = "Жестокий гладиатор: Сезон 4",
