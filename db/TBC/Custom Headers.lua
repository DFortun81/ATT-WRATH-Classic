...
for key,value in pairs({
	...
	[-1000226] = "Interface/Icons/Inv_drink_10",
	[-1000227] = "Interface/Icons/Spell_Misc_Drink",
	[-1000228] = _.asset("achievement_reputation_08"),
	[-1000230] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000231] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
	[-1000233] = "Interface/Icons/inv_chest_leather_08",
	[-1000234] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000235] = "Interface/Icons/inv_misc_questionmark",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000210] = "Dark Portal Pass",
	[-1000218] = "TBC Classic Deluxe Edition",
	[-1000226] = "iCoke",
	[-1000227] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000228] = REFER_A_FRIEND,
	[-1000230] = "Spirit of Competition",
	[-1000231] = BATTLE_PET_SOURCE_9,
	[-1000233] = "Ensembles",
	[-1000234] = "Arsenals",
	[-1000235] = "Sourceless",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000210] = "These rewards were made available to anyone who purchased a Dark Portal Pass for TBC Classic.\n\nThe act of adding items for real money to the In-Game Shop in Classic has widely been frowned upon.",
	...
	[-1000226] = "These were only available through the 2006 iCoke Promotion (China Only)",
	[-1000227] = "This section is for miscellaneous promotions that took place in the real world or something to do with account management.",
	[-1000230] = "This is a Battlegrounds-based event that coincides with the beginning of the Summer Olympic games. The only time this was celebrated was in 2008 to correspond to the Beijing Olympics, and although there appeared to be the intention to repeat this event, it never returned.",
	[-1000235] = "This Category contains Things that probably exist in the game but no known source.",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000210] = "Pass zum Dunklen Portal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000210] = "Pase para el Portal Oscuro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000210] = "Passe Porte des ténèbres",
...
for key,value in pairs({
	...
	[-1000210] = "Пропуск Темного портала",
	[-1000235] = "Без Источника",
}) do a[key] = value; end
end
