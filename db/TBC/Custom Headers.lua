...
for key,value in pairs({
	...
	[-1000182] = "Interface/Icons/inv_box_01",
	[-1000183] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000184] = "Interface/Icons/Inv_hammer_25",
	[-1000185] = "Interface/Icons/inv_stone_02",
	[-1000186] = "Interface/Icons/spell_holiday_tow_spicecloud",
...
for key,value in pairs({
	...
	[-1000182] = "The Ahn'Qiraj War Effort",
	[-1000183] = "The Opening of the Dark Portal",
	[-1000184] = "The Scepter of the Shifting Sands",
	[-1000185] = "The Scourge Invasion",
	[-1000186] = "The Silithyst Must Flow",
	[-1000191] = "BlizzCon",
...
for key,value in pairs({
	...
	[-1000183] = "Die Öffnung des Dunklen Portals",
	[-1000184] = "Das Szepter der Sandstürme",
...
for key,value in pairs({
	...
	[-1000183] = "La apertura del Portal Oscuro",
	[-1000184] = "El cetro del Mar de Dunas",
...
for key,value in pairs({
	...
	[-1000182] = "Effort de guerre d’Ahn'Qiraj",
	[-1000183] = "L'ouverture de la Porte des ténèbres",
	[-1000184] = "Le Sceptre des Sables changeants",
...
for key,value in pairs({
	...
	[-1000183] = "L'apertura del Portale Oscuro",
	[-1000184] = "Scettro delle Sabbie Mutevoli",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000183] = "A abertura do Portal Negro",
	[-1000184] = "Cetro das Areias Cambiantes",
...
for key,value in pairs({
	...
	[-1000182] = "Война в Ан'Кираже",
	[-1000183] = "Открытие Темного портала",
	[-1000184] = "Скипетр Зыбучих песков",
	[-1000185] = "Вторжение Плети",
