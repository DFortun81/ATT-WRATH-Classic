...
for key,value in pairs({
	...
	[-1000124] = "Interface/Icons/INV_BannerPVP_02",
	[-1000129] = "Interface/Icons/inv_sword_48",
	[-1000131] = _.asset("Category_PvP"),
	[-1000136] = _.asset("Event_dmf"),
	...
	[-1000163] = _.asset("Holiday_Children"),
	...
	[-1000186] = "Interface/Icons/inv_box_01",
	[-1000188] = "Interface/Icons/Inv_hammer_25",
	[-1000189] = "Interface/Icons/inv_stone_02",
	[-1000190] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000195] = _.asset("Promotion_Blizzcon"),
	[-1000196] = _.asset("Promotion_Collector"),
	[-1000213] = "Interface/Icons/Inv_drink_10",
	[-1000214] = "Interface/Icons/Spell_Misc_Drink",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000129] = "Honor Titles",
	[-1000131] = PVP,
	[-1000136] = "Darkmoon Faire",
	...
	[-1000163] = "Children's Week",
	[-1000165] = GetSpellInfo(21953),
	[-1000167] = "Hallow's End",
	[-1000168] = "Harvest Festival",
	[-1000171] = "Love is in the Air",
	[-1000172] = "Lunar Festival",
	[-1000174] = "Midsummer Fire Festival",
	[-1000175] = "Noblegarden",
	[-1000179] = "Stranglethorn Fishing Extravaganza",
	[-1000186] = "The Ahn'Qiraj War Effort",
	[-1000188] = "The Scepter of the Shifting Sands",
	[-1000189] = "The Scourge Invasion",
	[-1000190] = "The Silithyst Must Flow",
	[-1000195] = "BlizzCon",
	[-1000196] = "Collector's Edition",
	[-1000213] = "iCoke",
	[-1000214] =  AUCTION_CATEGORY_MISCELLANEOUS,
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000188] = "Das Szepter der Sandstürme",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000188] = "El cetro del Mar de Dunas",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000186] = "Effort de guerre d’Ahn'Qiraj",
	[-1000188] = "Le Sceptre des Sables changeants",
	[-1000196] = "Edition Collector",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000188] = "Scettro delle Sabbie Mutevoli",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000188] = "Cetro das Areias Cambiantes",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000186] = "Война в Ан'Кираже",
	[-1000188] = "Скипетр Зыбучих песков",
	[-1000189] = "Вторжение Плети",
	[-1000196] = "Коллекционное издание",
}) do a[key] = value; end
end
