...
for key,value in pairs({
	...
	[-1000122] = "Interface/Icons/INV_BannerPVP_02",
...
for key,value in pairs({
	...
	[-1000161] = "Children's Week",
	[-1000163] = GetSpellInfo(21953),
	[-1000165] = "Hallow's End",
	[-1000166] = "Harvest Festival",
	[-1000169] = "Love is in the Air",
	[-1000170] = "Lunar Festival",
