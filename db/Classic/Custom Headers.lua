...
_.HeaderConstants = {
	...
	REWARDS = -1000031,
	SPECIAL = -1000035,
	TIER_ZERO_POINT_FIVE_SETS = -1000139,
	TREASURES = -1000036,
	VENDORS = -1000037,
	WEAPONS = -1000071,
...
for key,value in pairs({
	...
	[-1000139] = "Interface/Icons/INV_Chest_Plate03",
	[-1000140] = "Interface/Icons/achievement_pvp_h_12",
	[-1000141] = "Interface/Icons/Inv_misc_ahnqirajtrinket_06",
	[-1000142] = "Interface/Icons/Ability_mount_undeadhorse",
	[-1000143] = _.asset("Achievement_Zone_Blackrock_01"),
	[-1000144] = _.asset("Achievement_Zone_Blackrock_01"),
	[-1000145] = _.asset("Achievement_Boss_Overlord_Wyrmthalak"),
	[-1000146] = "Interface/Icons/INV_Misc_Head_Dragon_01",
	[-1000147] = "Interface/Icons/Spell_Shadow_SummonImp",
	[-1000148] = "Interface/Icons/inv_axe_10",
	[-1000149] = "Interface/Icons/INV_Misc_Head_Elf_02",
	[-1000150] = "Interface/Icons/spell_arcane_portalironforge",
	[-1000151] = "Interface/Icons/INV_Misc_Gem_Opal_01",
	[-1000152] = "Interface/Icons/INV_Misc_Gem_Amethyst_02",
	[-1000153] = "Interface/Icons/Inv_misc_bone_humanskull_01",
	[-1000154] = "Interface/Icons/INV_Misc_Book_13",
	[-1000155] = "Interface/Icons/inv_helmet_25",
	[-1000156] = "Interface/Icons/inv_helmet_12",
	[-1000157] = "Interface/Icons/INV_Misc_Token_ScarletCrusade",
	[-1000158] = "Interface/Icons/INV_MISC_KEY_13",
	[-1000159] = "Interface/Icons/Inv_misc_head_troll_01",
	...
	[-1000221] = "Interface/Icons/inv_chest_leather_08",
	[-1000222] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000223] = "Interface/Icons/inv_misc_questionmark",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000138] = "Crieve's Never Implemeneted List",
	[-1000139] = "Tier 0.5 Sets",
	[-1000140] = "Captains",
	[-1000141] = "Silithid Royalty",
	[-1000142] = "The Four Horsemen",
	[-1000143] = DUNGEON_FLOOR_BLACKROCKDEPTHS1,
	[-1000144] = DUNGEON_FLOOR_BLACKROCKDEPTHS2,
	[-1000145] = DUNGEON_FLOOR_BLACKROCKSPIRE3,
	[-1000146] = DUNGEON_FLOOR_UPPERBLACKROCKSPIRE1,
	[-1000147] = DUNGEON_FLOOR_DIREMAUL5.." (East)",
	[-1000148] = DUNGEON_FLOOR_DIREMAUL1.." (North)",
	[-1000149] = DUNGEON_FLOOR_DIREMAUL2.." (West)",
	[-1000150] = GetSpellInfo(21127),
	[-1000151] = DUNGEON_FLOOR_DESOLACE22.." (Orange Path)",
	[-1000152] = DUNGEON_FLOOR_DESOLACE21.." (Purple Path)",
	[-1000153] = "Graveyard",
	[-1000154] = "Library",
	[-1000155] = "Armory",
	[-1000156] = "Cathedral",
	[-1000157] = "Main Gate",
	[-1000158] = "Service Entrance",
	[-1000159] = "Atal'ai Defenders",
	[-1000165] = "Children's Week",
	[-1000167] = GetSpellInfo(21953),
	[-1000169] = "Hallow's End",
	[-1000170] = "Harvest Festival",
	[-1000173] = "Love is in the Air",
	[-1000174] = "Lunar Festival",
...
for key,value in pairs({
	...
	[-1000138] = "If the following are sorted somewhere, please delete them from this list. Thanks.",
	[-1000145] = "Also known as 'Lower' Blackrock Spire.",
	[-1000146] = "Also known as 'Upper' Blackrock Spire.",
	[-1000147] = "This part of the instance can be accessed from the eastern-most portal. (right side)",
	[-1000148] = "This part of the instance can be accessed from the northern-most portal.",
	[-1000149] = "This part of the instance can be accessed from the western-most portal. (left side)",
	...
	[-1000223] = "This Category contains Things that probably exist in the game but no known source.",
}) do a[key] = value; end

local a = L.HEADER_LORE;
for key,value in pairs({
	[-1000046] = "One of these dragons will spawn randomly at the associated coordinates across Azeroth.",
	[-1000139] = "The Dungeon Set 2 class sets, commonly referred to as Tier 0.5, are obtained by completing a long quest chain to upgrade the first set available as drops in end game dungeons into stronger versions of themselves. In current WoW, these sets are covetted by Collectors as the quest chain was completely removed from the game with Cataclysm. In WoW Classic, you should finish this quest chain on all of your characters before then!",
	[-1000140] = "These can be farmed infinitely by resetting the boss.",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000142] = "Die Vier Reiter",
	[-1000153] = "Friedhof",
	[-1000154] = "Bibliothek",
	[-1000155] = "Waffenkammer",
	[-1000156] = "Kathedrale",
...
for key,value in pairs({
	...
	[-1000139] = "Ensembles Tier 0.5",
	[-1000140] = "Capitaines",
	[-1000142] = "Les quatre cavaliers",
	[-1000147] = DUNGEON_FLOOR_DIREMAUL5.." (Est)",
	[-1000148] = DUNGEON_FLOOR_DIREMAUL1.." (Nord)",
	[-1000149] = DUNGEON_FLOOR_DIREMAUL2.." (Ouest)",
	[-1000153] = "Cimetière",
	[-1000154] = "Librairie",
	[-1000155] = "Armurerie",
	[-1000156] = "Cathédrale",
	[-1000159] = "Défenseurs Atal'ai",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000142] = "I Cavalieri dell'Apocalisse",
...
for key,value in pairs({
	...
	[-1000139] = "Комплекты T0.5",
	[-1000140] = "Капитаны",
	[-1000142] = "Четыре Всадника",
	[-1000147] = DUNGEON_FLOOR_DIREMAUL5.." (Восток)",
	[-1000148] = DUNGEON_FLOOR_DIREMAUL1.." (Север)",
	[-1000149] = DUNGEON_FLOOR_DIREMAUL2.." (Запад)",
	[-1000153] = "Кладбище",
	[-1000154] = "Библиотека",
	[-1000155] = "Оружейная",
	[-1000156] = "Собор",
	[-1000159] = "Защитники Атал'ай",
...
for key,value in pairs({
	...
	[-1000140] = "船长",
	[-1000142] = "四骑士",
	[-1000147] = DUNGEON_FLOOR_DIREMAUL5.." (东)",
	[-1000148] = DUNGEON_FLOOR_DIREMAUL1.." (北)",
	[-1000149] = DUNGEON_FLOOR_DIREMAUL2.." (西)",
	[-1000153] = "墓地",
	[-1000154] = "图书馆",
	[-1000155] = "武器库",
	[-1000156] = "修道院",
