...
for key,value in pairs({
	...
	[-1000176] = _.asset("Expansion_CATA"),
	[-1000177] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000178] = "Interface/Icons/inv_box_01",
	[-1000179] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	...
	[-1000188] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	...
	[-1000195] = "Interface/Icons/DiabloAnniversary_HoradricCube",
	[-1000199] = "Interface/Icons/Inv_sigil_thorim",
	[-1000202] = _.asset("Expansion_TBC"),
	[-1000204] = _.asset("Expansion_WOTLK"),
	[-1000205] = _.asset("Expansion_WOTLK"),
	[-1000210] = "Interface/Icons/Inv_drink_10",
	[-1000211] = "Interface/Icons/Spell_Misc_Drink",
	[-1000212] = "Interface/Icons/achievement_reputation_08",
	[-1000213] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000214] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000215] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000176] = "Elemental Unrest",
	[-1000177] = select(2, GetAchievementInfo(4786)),
	[-1000178] = "The Ahn'Qiraj War Effort",
	[-1000179] = "The Opening of the Dark Portal",
	...
	[-1000188] = select(2, GetAchievementInfo(4790)),
	[-1000192] = "BlizzCon",
	[-1000193] = "Collector's Edition",
	[-1000194] = "Dark Portal Pass",
	[-1000195] = "Diablo III",
	[-1000199] = "Starcraft II: Wings of Liberty",
	[-1000202] = "TBC Classic Deluxe Edition",
	[-1000204] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000205] = "WotLK Classic Northrend Epic Upgrade",
	[-1000210] = "iCoke",
	[-1000211] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000212] = REFER_A_FRIEND,
	[-1000213] = SCROLL_OF_RESURRECTION,
	[-1000214] = "Spirit of Competition",
	[-1000215] = BATTLE_PET_SOURCE_9,
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000176] = "The Elemental Unrest was a world event that heralded the Cataclysm. The event culminated in elementals attacking Stormwind, Orgrimmar, Ironforge, and Thunder Bluff. Players defeating these elementals and freeing trapped citizens within their entire city were granted access to two special boss encounters.",
	[-1000177] = "Operation: Gnomeregan was the name of Gelbin Mekkatorque's plan for the retaking of the surface of Gnomeregan. Only Alliance players between level 75 and 80 were able to serve during the operation, but lower level players helped by motivating other gnomes or by turning in items.",
	...
	[-1000188] = "Zalazane's Fall (also referred to as the Battle to reclaim the Echo Isles) was the final push by Vol'jin and the Darkspear tribe to retake the Echo Isles from the clutches of the evil Zalazane. It was a culminating event for the Horde to occur before the release of the next expansion, Cataclysm. Furthermore, all troll characters created after the liberation of the Echo Isles now have their new starting point there.",
	[-1000194] = "These rewards were made available to anyone who purchased a Dark Portal Pass for TBC Classic.\n\nThe act of adding items for real money to the In-Game Shop in Classic has widely been frowned upon.",
	[-1000195] = "These rewards were made available to anyone who purchased a Collector's Edition of Diablo III.",
	[-1000199] = "These rewards are available to anyone who purchased the Collector's Edition for Starcraft II: Wings of Liberty.",
	[-1000202] = "These rewards were made available to anyone who purchased a Deluxe Edition of TBC Classic. (not to be confused with the original Burning Crusade Collector's Edition)",
	...
	[-1000205] = "These rewards were made available to anyone who purchased a Northrend Heroic Upgrade for WotLK Classic. (not to be confused with the original Wrath of the Lich King Collector's Edition)",
	...
	[-1000213] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
	[-1000214] = "This is a Battlegrounds-based event that coincides with the beginning of the Summer Olympic games. The only time this was celebrated was in 2008 to correspond to the Beijing Olympics, and although there appeared to be the intention to repeat this event, it never returned.",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000179] = "Die Öffnung des Dunklen Portals",
	[-1000180] = "Das Szepter der Sandstürme",
	[-1000194] = "Pass zum Dunklen Portal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000179] = "La apertura del Portal Oscuro",
	[-1000180] = "El cetro del Mar de Dunas",
	[-1000194] = "Pase para el Portal Oscuro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000179] = "L'ouverture de la Porte des ténèbres",
	[-1000180] = "Le Sceptre des Sables changeants",
	[-1000193] = "Edition Collector",
	[-1000194] = "Passe Porte des ténèbres",
	[-1000202] = "Édition BC Classic Deluxe",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000179] = "L'apertura del Portale Oscuro",
...
for key,value in pairs({
	...
	[-1000179] = "A abertura do Portal Negro",
	[-1000180] = "Cetro das Areias Cambiantes",
	[-1000194] = "Passe do Portal Negro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000195] = "暗黑破坏神III",
	[-1000199] = "星际争霸II：自由之翼",
	[-1000202] = "燃烧的远征经典怀旧服典藏包",
	[-1000204] = "巫妖王之怒经典怀旧服诺森德英雄礼包",
	[-1000205] = "巫妖王之怒经典怀旧服诺森德史诗礼包",
	[-1000210] = "可口可乐活动",
}) do a[key] = value; end
end
