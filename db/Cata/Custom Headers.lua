...
for key,value in pairs({
	...
	[-1000196] = "Interface/Icons/achievement_reputation_argentchampion",
	...
	[-1000228] = "Interface/Icons/achievement_reputation_08",
	[-1000229] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000230] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000231] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000180] = "WoW's Anniversary",
	[-1000181] = select(2,GetAchievementInfo(2398)),
	[-1000182] = select(2,GetAchievementInfo(4400)),
	[-1000183] = select(2,GetAchievementInfo(5512)),
	[-1000184] = select(2,GetAchievementInfo(5863)),
	[-1000185] = select(2,GetAchievementInfo(6131)),
	[-1000196] = select(1,GetCategoryInfo(14941)),
...
for key,value in pairs({
	...
	[-1000180] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
	...
	[-1000229] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
