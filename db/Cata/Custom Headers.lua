...
for key,value in pairs({
	...
	[-1000161] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000162] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000163] = "Interface/Icons/inv_misc_celebrationcake_01",
	...
	[-1000170] = "Interface/Icons/DiabloAnniversary_HoradricCube",
	...
	[-1000188] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000189] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000190] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000161] = select(2,GetAchievementInfo(5512)),
	[-1000162] = select(2,GetAchievementInfo(5863)),
	[-1000163] = select(2,GetAchievementInfo(6131)),
	[-1000167] = "BlizzCon",
	...
	[-1000188] = SCROLL_OF_RESURRECTION,
...
for key,value in pairs({
	...
	[-1000170] = "These rewards were made available to anyone who purchased a Collector's Edition of Diablo III.",
	...
	[-1000188] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
