...
for key,value in pairs({
	...
	[-1000234] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000235] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000236] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
...
for key,value in pairs({
	...
	[-1000188] = select(2,GetAchievementInfo(5512)),
	[-1000189] = select(2,GetAchievementInfo(5863)),
	[-1000190] = select(2,GetAchievementInfo(6131)),
	...
	[-1000234] = SCROLL_OF_RESURRECTION,
...
for key,value in pairs({
	...
	[-1000234] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
