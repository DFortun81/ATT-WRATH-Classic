...
_.HeaderConstants = {
	...
	DAY_OF_THE_DEAD_HEADER = -1000165,
	DISCOVERY = -1000015,
	EXPLORATION = -1000018,
	FACTIONS = -1000019,
	...
	PILGRIMS_BOUNTY_HEADER = -1000177,
...
for key,value in pairs({
	...
	[-1000130] = "Interface/Icons/inv_jewelry_amulet_03",
	...
	[-1000145] = "Interface/Icons/Ability_Warlock_DemonicEmpowerment",
	[-1000146] = "Interface/Icons/Achievement_Reputation_Ogre",
	...
	[-1000158] = "Interface/Icons/achievement_dungeon_icecrown_icecrownentrance",
	[-1000159] = "Interface/Icons/achievement_dungeon_plaguewing",
	[-1000160] = "Interface/Icons/achievement_dungeon_crimsonhall",
	[-1000161] = "Interface/Icons/achievement_dungeon_icecrown_frostwinghalls",
	[-1000162] = _.asset("Holiday_brewfest"),
	[-1000164] = _.asset("Holiday_Children"),
	[-1000165] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000166] = _.asset("Holiday_winter_veil"),
	[-1000168] = _.asset("Holiday_hallows_end"),
	[-1000169] = _.asset("Holiday_Harvestfest"),
	[-1000171] = "Interface/Icons/inv_fishingpole_03",
	...
	[-1000177] = _.asset("Holiday_Pilgrim"),
	...
	[-1000200] = "Interface/Icons/achievement_reputation_argentchampion",
...
for key,value in pairs({
	...
	[-1000158] = "Storming the Citadel",
	[-1000159] = "The Plagueworks",
	[-1000160] = C_Map.GetAreaInfo(4892),
	[-1000161] = "The Frostwing Halls",
	[-1000162] = select(1,GetCategoryInfo(162)),
	[-1000164] = select(1,GetCategoryInfo(163)),
	[-1000165] = "Day of the Dead",
	[-1000166] = GetSpellInfo(21953),
	[-1000168] = select(1,GetCategoryInfo(158)),
	[-1000169] = "Harvest Festival",
	[-1000171] = "Kalu'ak Fishing Derby",
	...
	[-1000177] = select(1,GetCategoryInfo(14981)),
	[-1000178] = "Pirates' Day",
	[-1000180] = "Stranglethorn Fishing Extravaganza",
	[-1000184] = "WoW's Anniversary",
	[-1000185] = select(2,GetAchievementInfo(2398)),
	[-1000186] = select(2,GetAchievementInfo(4400)),
	[-1000200] = select(1,GetCategoryInfo(14941)),
	...
	[-1000224] = "WotLK Classic Northrend Heroic Upgrade",
...
for key,value in pairs({
	...
	[-1000144] = "One member of your group must have completed the Seal of Ascension quest chain in order for the fires to light and the door to open to this portion of the instance. Also known as 'Upper' Blackrock Spire.",
	...
	[-1000184] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
...
for key,value in pairs({
	...
	[-1000154] = "Kathedrale",
	[-1000158] = "Sturm auf die Zitadelle",
	[-1000159] = "Die Seuchenwerke",
	[-1000161] = "Die Frostschwingenhallen",
	[-1000165] = "Tag der Toten",
	[-1000171] = "Angelwettstreit der Kalu'ak",
...
for key,value in pairs({
	...
	[-1000158] = "Asaltar la Ciudadela",
	[-1000159] = "Los Talleres de la Peste",
	[-1000161] = "Las Cámaras de Alaescarcha",
	[-1000165] = "Festividad de los Muertos",
	[-1000171] = "Competición de pesca Kalu'ak",
...
for key,value in pairs({
	...
	[-1000158] = "La prise de la citadelle",
	[-1000159] = "La Pesterie",
	[-1000161] = "Les salles de l'Aile de givre",
	[-1000165] = "Jour des morts",
	[-1000171] = "Le tournoi de pêche kalu'ak",
...
for key,value in pairs({
	...
	[-1000158] = "Assalto alla rocca",
	[-1000159] = "Sale della Pestilenza",
	[-1000161] = "Sale delle Ali del Gelo",
	[-1000165] = "Giorno dei Morti",
	[-1000171] = "La gara di pesca dei Kalu'ak",
...
for key,value in pairs({
	...
	[-1000158] = "Invasão da Cidadela",
	[-1000159] = "Antro da Peste",
	[-1000161] = "Salões da Asa Gélida",
	[-1000165] = "Dia dos Mortos",
	[-1000171] = "Campeonato de Pesca dos Kalu'ak",
...
for key,value in pairs({
	...
	[-1000158] = "Штурм цитадели",
	[-1000159] = "Чумодельня",
	[-1000161] = "Залы Ледокрылых",
	[-1000165] = "День мертвых",
	[-1000171] = "Калуакское рыбоборье",
