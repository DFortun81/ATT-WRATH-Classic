...
_.HeaderConstants = {
	...
	DAY_OF_THE_DEAD_HEADER = -1000172,
	DISCOVERY = -1000015,
	EXPLORATION = -1000018,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000173,
	FLIGHT_PATHS = -1000020,
	HALLOWS_END_HEADER = -1000175,
	HARVEST_FESTIVAL_HEADER = -1000176,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000130,
	IN_GAME_SHOP = -1000089,
	LOVE_IS_IN_THE_AIR_HEADER = -1000179,
	LUNAR_FESTIVAL_HEADER = -1000180,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000182,
	NOBLEGARDEN_HEADER = -1000183,
	PILGRIMS_BOUNTY_HEADER = -1000184,
	PIRATES_DAY_HEADER = -1000185,
	PROFESSIONS = -1000028,
	PVP = -1000132,
...
for key,value in pairs({
	...
	[-1000172] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000173] = _.asset("Holiday_winter_veil"),
	[-1000175] = _.asset("Holiday_hallows_end"),
	[-1000176] = _.asset("Holiday_Harvestfest"),
	[-1000178] = "Interface/Icons/inv_fishingpole_03",
	[-1000179] = _.asset("Holiday_love"),
	[-1000180] = _.asset("Holiday_Lunar"),
	[-1000182] = _.asset("Holiday_Midsummer"),
	[-1000183] = _.asset("Holiday_noblegarden"),
	[-1000184] = _.asset("Holiday_Pilgrim"),
	[-1000185] = _.asset("Holiday_Pirate"),
	[-1000187] = "Interface/Icons/inv_misc_fish_06",
	...
	[-1000207] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000208] = _.asset("Expansion_CATA"),
	[-1000209] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	...
	[-1000215] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	...
	[-1000239] = "Interface/Icons/achievement_reputation_08",
...
for key,value in pairs({
	...
	[-1000172] = "Day of the Dead",
	[-1000173] = GetSpellInfo(21953),
	[-1000175] = select(1,GetCategoryInfo(158)),
	[-1000176] = "Harvest Festival",
	[-1000178] = "Kalu'ak Fishing Derby",
	[-1000179] = select(1,GetCategoryInfo(187)),
	[-1000180] = select(1,GetCategoryInfo(160)),
	[-1000182] = "Midsummer Fire Festival",
	[-1000183] = select(1,GetCategoryInfo(159)),
	[-1000184] = select(1,GetCategoryInfo(14981)),
	[-1000185] = "Pirates' Day",
	[-1000187] = "Stranglethorn Fishing Extravaganza",
	[-1000191] = "WoW's Anniversary",
	[-1000192] = select(2,GetAchievementInfo(2398)),
	[-1000193] = select(2,GetAchievementInfo(4400)),
	[-1000207] = select(1,GetCategoryInfo(14941)),
	[-1000208] = "Elemental Unrest",
	[-1000209] = select(2, GetAchievementInfo(4786)),
	...
	[-1000215] = select(2, GetAchievementInfo(4790)),
	[-1000219] = "BlizzCon",
...
for key,value in pairs({
	...
	[-1000191] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
	[-1000208] = "The Elemental Unrest was a world event that heralded the Cataclysm. The event culminated in elementals attacking Stormwind, Orgrimmar, Ironforge, and Thunder Bluff. Players defeating these elementals and freeing trapped citizens within their entire city were granted access to two special boss encounters.",
	[-1000209] = "Operation: Gnomeregan was the name of Gelbin Mekkatorque's plan for the retaking of the surface of Gnomeregan. Only Alliance players between level 75 and 80 were able to serve during the operation, but lower level players helped by motivating other gnomes or by turning in items.",
...
for key,value in pairs({
	...
	[-1000172] = "Tag der Toten",
	[-1000178] = "Angelwettstreit der Kalu'ak",
	[-1000182] = "Sonnenwendfest",
	[-1000185] = "Piratentag",
	[-1000187] = "Anglerwettbewerb im Schlingendorntal",
...
for key,value in pairs({
	...
	[-1000172] = "Festividad de los Muertos",
	[-1000178] = "Competición de pesca Kalu'ak",
	[-1000182] = "Festival del Fuego del Solsticio de Verano",
	[-1000185] = "Día de los Piratas",
	[-1000187] = "Gran espectáculo de pesca de Tuercespina",
...
for key,value in pairs({
	...
	[-1000172] = "Jour des morts",
	[-1000178] = "Le tournoi de pêche kalu'ak",
	[-1000182] = "Fête du Feu du solstice d’été",
	[-1000185] = "Jour des pirates",
	[-1000187] = "Concours de pêche de Strangleronce",
...
for key,value in pairs({
	...
	[-1000172] = "Giorno dei Morti",
	[-1000178] = "La gara di pesca dei Kalu'ak",
	[-1000182] = "Fuochi di Mezza Estate",
	[-1000185] = "Giorno dei Pirati",
	[-1000187] = "Gara di Pesca a Rovotorto",
...
for key,value in pairs({
	...
	[-1000172] = "Dia dos Mortos",
	[-1000178] = "Campeonato de Pesca dos Kalu'ak",
	[-1000182] = "Festival do Fogo do Solstício",
	[-1000185] = "Dia dos Piratas",
	[-1000187] = "Festerê de Pesca da Selva do Espinhaço",
...
for key,value in pairs({
	...
	[-1000172] = "День мертвых",
	[-1000178] = "Калуакское рыбоборье",
	[-1000182] = "Огненный Солнцеворот",
	[-1000185] = "День пирата",
	[-1000187] = "Рыбомания Тернистой долины",
	[-1000208] = "Буйство элементалей",
