...
_.HeaderConstants = {
	...
	BREWFEST_HEADER = -1000164,
	CHILDRENS_WEEK_HEADER = -1000166,
...
for key,value in pairs({
	...
	[-1000147] = "Interface/Icons/Ability_Warlock_DemonicEmpowerment",
	[-1000148] = "Interface/Icons/Achievement_Reputation_Ogre",
	...
	[-1000160] = "Interface/Icons/achievement_dungeon_icecrown_icecrownentrance",
	[-1000161] = "Interface/Icons/achievement_dungeon_plaguewing",
	[-1000162] = "Interface/Icons/achievement_dungeon_crimsonhall",
	[-1000163] = "Interface/Icons/achievement_dungeon_icecrown_frostwinghalls",
	[-1000164] = _.asset("Holiday_brewfest"),
	[-1000166] = _.asset("Holiday_Children"),
...
for key,value in pairs({
	...
	[-1000160] = "Storming the Citadel",
	[-1000161] = "The Plagueworks",
	[-1000162] = C_Map.GetAreaInfo(4892),
	[-1000163] = "The Frostwing Halls",
	[-1000164] = select(1,GetCategoryInfo(162)),
	[-1000166] = select(1,GetCategoryInfo(163)),
...
for key,value in pairs({
	...
	[-1000146] = "One member of your group must have completed the Seal of Ascension quest chain in order for the fires to light and the door to open to this portion of the instance. Also known as 'Upper' Blackrock Spire.",
...
for key,value in pairs({
	...
	[-1000156] = "Kathedrale",
	[-1000160] = "Sturm auf die Zitadelle",
	[-1000161] = "Die Seuchenwerke",
	[-1000163] = "Die Frostschwingenhallen",
...
for key,value in pairs({
	...
	[-1000160] = "Asaltar la Ciudadela",
	[-1000161] = "Los Talleres de la Peste",
	[-1000163] = "Las Cámaras de Alaescarcha",
...
for key,value in pairs({
	...
	[-1000160] = "La prise de la citadelle",
	[-1000161] = "La Pesterie",
	[-1000163] = "Les salles de l'Aile de givre",
...
for key,value in pairs({
	...
	[-1000160] = "Assalto alla rocca",
	[-1000161] = "Sale della Pestilenza",
	[-1000163] = "Sale delle Ali del Gelo",
...
for key,value in pairs({
	...
	[-1000160] = "Invasão da Cidadela",
	[-1000161] = "Antro da Peste",
	[-1000163] = "Salões da Asa Gélida",
...
for key,value in pairs({
	...
	[-1000160] = "Штурм цитадели",
	[-1000161] = "Чумодельня",
	[-1000163] = "Залы Ледокрылых",
